...
function isAllowedResource(target) {
...
export function selectForwardHeaders(headersFromBrowser, target) {
...
async function forward(request, response, target, targetType) {
...
export function mineruProxyPlugin() {
    return {
